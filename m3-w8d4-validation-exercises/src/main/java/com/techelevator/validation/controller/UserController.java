...
public class UserController {
	...
	public String getRegistrationForm(ModelMap modelHolder) {
		if ( ! modelHolder.containsAttribute("registration")) { // if we dont have one create it
	...
	public String processRegistration(@Valid @ModelAttribute Registration regData, BindingResult result, RedirectAttributes flash) {
		...
		System.out.println(regData.getFirstName());
	...
	public String getLogin(ModelMap modelHolder) {
		if ( ! modelHolder.containsAttribute("login")) { // if we dont have one create it
	...
	public String processLogin(@Valid @ModelAttribute Login logData, BindingResult result, RedirectAttributes flash) {
	...
	public String getConfirmation(ModelMap modelHolder) {
